    ...
    <Fragment>
      <Grid>
        ...
        <Grid.Column width={4}>
          ...
          <PhotoUploadWidgetDropzone setFiles = {setFiles}></PhotoUploadWidgetDropzone>
        </Grid.Column>
        <Grid.Column width={1} />
        <Grid.Column width={4}>
          <Header sub color="teal" content="Step 2 - Resize image" />
          {files.length > 0 &&  <PhotoUploadWidgetCropper setImage = {setImage} imagePreview= {files[0].preview} />}
        </Grid.Column>
        <Grid.Column width={1} />
        <Grid.Column width={4}>
